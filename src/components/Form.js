...
const Form = ({ form, setForm, submitForm, errors, planSelected, planList }) => {
  ...
  return (Object.keys(planList).length > 0 &&
    <div className={styles.root}>
      ...
      <button className={styles.btn} onClick={submitFormHandler}>Pagar S/ {planList[planSelected].price.toFixed(2)}</button>
    </div>)
}
